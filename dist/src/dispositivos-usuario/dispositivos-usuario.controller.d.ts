...
export declare class DispositivoUsuariosController {
    private readonly service;
    constructor(service: DispositivoUsuariosService);
    ...
    liberate(userId: number): Promise<import("@prisma/client").Prisma.BatchPayload>;
