...
let UsuariosController = class UsuariosController {
    ...
    updateProfile(userId, updateDto) {
        const { rol_id, estado, correo_verificado, ...safeDto } = updateDto;
...
__decorate([
    (0, common_1.Get)('rol/:nombre'),
    (0, roles_decorator_1.Roles)('admin'),
    (0, swagger_1.ApiOperation)({ summary: 'Listar usuarios por nombre de rol' }),
    __param(0, (0, common_1.Param)('nombre')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], UsuariosController.prototype, "findByRole", null);
__decorate([
    (0, common_1.Get)(),
    (0, roles_decorator_1.Roles)('admin'),
